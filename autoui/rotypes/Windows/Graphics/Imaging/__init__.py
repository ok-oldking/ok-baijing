...
import autoui.rotypes.Windows.Storage.Streams
from autoui.rotypes.Windows.Foundation import IClosable
from autoui.rotypes.idldsl import define_winrt_com_method, _static_method, runtimeclass, GUID
...
define_winrt_com_method(ISoftwareBitmapStatics, "CreateCopyWithAlphaFromBuffer",
                        autoui.rotypes.Windows.Storage.Streams.IBuffer, BitmapPixelFormat, c_int32, c_int32,
                        BitmapAlphaMode,
