...
from autoui.rotypes.Windows.Foundation import IReference, Rect, IAsyncOperation
from autoui.rotypes.Windows.Foundation.Collections import IVectorView
from autoui.rotypes.Windows.Globalization import Language
from autoui.rotypes.Windows.Graphics.Imaging import SoftwareBitmap
from autoui.rotypes.idldsl import define_winrt_com_method, _static_propget, _static_method, _non_activatable_init, \
    runtimeclass, GUID
from autoui.rotypes.inspectable import IInspectable
from autoui.rotypes.winstring import HSTRING
