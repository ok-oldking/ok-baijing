...
from autoui.rotypes import delegate, HSTRING
from autoui.rotypes.idldsl import define_winrt_com_method, generics_cache, define_winrt_com_delegate, pinterface_type, \
    GUID
